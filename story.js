...
const oStory = {
    start: {
        text: '我收了鏡子，想道：“這道士倒有意思，我何不照一照試試。”想畢，拿起"風月鑒"來。一開始是鏡子反面',
        add: ["我", "照", "風月鑑"],
        img: "風月鑒(模糊)"
    },
    我照風月鑑: {
    ...
    我照風月鑑00: {
        text: '只見一個骷髏立在里面，唬得我連忙掩了，罵：“道士混帳，如何嚇我！-我倒再翻面看看正面是什么。',
        add: ["翻面"],
        img: "風月鑒(骷髏)"
    },
    我照風月鑑01: {
    ...
    我照風月鑑10: {
        text: '我將正面一照，只見鳳姐站在里面招手叫他．賈瑞心中一喜，蕩悠悠的覺得進了鏡子，与鳳姐云雨一番，鳳姐仍送他出來．到了床上，哎喲了一聲，一睜眼，鏡子從手里掉過來，仍是反面立著一個骷髏．賈瑞自覺汗津津的，底下已遺了一灘精．',
        img: "風月鑒(鳳姐)"
    },
    我照風月鑑11: {
    ...
    我看枷鎖: {
        text: '這個枷鎖把我的手禁錮住了，讓我非常不方便。它看起來有點老舊，外表都生鏽了一大片，說不定我可以想辦法破壞它。'
    },
    我看壞掉的枷鎖: {
    ...
    我看稻草堆0: {
        text: '(稻草堆一移就散了)這裡有一堆稻草，還記得小時候看見窮人家的小孩會將稻草組合成的線，玩一個好像叫"繩飛"的遊戲，雖然是貧民的娛樂卻令我好生羨慕。等等，稻草堆裡好像有東西。'
    },
    我看稻草堆1: {
...
function setImg(s) {
    ...
    img.onload = () => $("#img").css("left", (650 - img.width / 2) + "px")
}
